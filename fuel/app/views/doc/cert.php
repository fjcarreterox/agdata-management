...
$pdf->Ln(5);
$pdf->MultiCell(0,8,utf8_decode('Asímismo se certifica el continuo cumplimiento de las disposiciones legales vigentes en materia de protección de datos, como consecuencia de los servicios de mantenimiento LOPD que se han contratado con esta empresa.'),0,'J');
$pdf->Ln(5);
...
$pdf->MultiCell(0,8,utf8_decode('Casimiro Galán Garrido       '),0,'R');
