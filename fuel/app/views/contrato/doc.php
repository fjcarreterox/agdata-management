...
$pdf->Ln(10);
$pdf->SetFont('Arial','',12);
$pdf->MultiCell(0,6,utf8_decode('          De una parte, D., mayor de edad, con DNI nº , como representante legal de la empresa X. Con CIF Nº B-, con domicilio en la calle C.P. de, Se hace constar que interviene como mandatario de la Comunidad de Propietarios , CIF nº H (en adelante, EL BENEFICIARIO).'),0);
$pdf->Ln(10);
