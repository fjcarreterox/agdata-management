...
<?php if ($agendas):
    ...
    $body_pod = 'A/A.:%0D%0A%0D%0ABuenos días,%0D%0A%0D%0ASegún conversación telefónica, le hacemos llegar información sobre nuestros servicios en materia de Protección de Datos.%0D%0A%0D%0AComo asesores jurídicos del Colegio de Podólogos de Andalucía, podrán beneficiarse de unas tarifas muy económicas orientadas a los profesionales colegiados.%0D%0A%0D%0AComo podrá comprobar, Análisis y Gestión de Datos SL, se encarga de actualizarles toda la documentación legal necesaria, de modificar o inscribir en la Agencia Española de Protección de Datos los ficheros de datos que gestione en su clínica, así como del asesoramiento jurídico ante cualquier consulta que puedan plantearle en materia de protección de datos.%0D%0A%0D%0ASin otro particular, le instamos a poder ampliarles esta información en una visita personal, para conocer su situación actual, así como aclararle cualquier consulta que le surja.%0D%0A%0D%0AReciba un cordial saludo.%0D%0A%0D%0A ';
