			...
			<td>
				<div class="btn-toolbar">
					<div class="btn-group">
                        ...
                        <?php echo Html::anchor('usuario/view/'.$item->id, '<i class="icon-eye-open"></i> Cambiar contraseña', array('class' => 'btn btn-info btn-sm')); ?>
                        <?php echo Html::anchor('usuario/edit/'.$item->id, '<i class="icon-wrench"></i> Editar', array('class' => 'btn btn-success btn-sm')); ?>
